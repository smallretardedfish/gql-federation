...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		switch typeName {
		case "Encounter":
			resolverName, err := entityResolverNameForEncounter(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Encounter": %w`, err)
			}
			switch resolverName {
			...
			case "findEncounterByID":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findEncounterByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindEncounterByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Encounter": %w`, err)
				}
...
func entityResolverNameForEncounter(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
		...
		return "findEncounterByID", nil
	}
	return "", fmt.Errorf("%w for Encounter", ErrTypeNotFound)
}
