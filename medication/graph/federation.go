...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		switch typeName {
		case "Medication":
			resolverName, err := entityResolverNameForMedication(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Medication": %w`, err)
			}
			switch resolverName {
			...
			case "findMedicationByID":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findMedicationByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindMedicationByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Medication": %w`, err)
				}
		...
		case "Patient":
			resolverName, err := entityResolverNameForPatient(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Patient": %w`, err)
			}
			switch resolverName {
			...
			case "findPatientByID":
				id0, err := ec.unmarshalNID2int64(ctx, rep["id"])
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findPatientByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindPatientByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Patient": %w`, err)
				}
...
func entityResolverNameForMedication(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
		...
		return "findMedicationByID", nil
	}
	return "", fmt.Errorf("%w for Medication", ErrTypeNotFound)
}
...
func entityResolverNameForPatient(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
			m   map[string]interface{}
			val interface{}
		...
		return "findPatientByID", nil
	}
	return "", fmt.Errorf("%w for Patient", ErrTypeNotFound)
}
